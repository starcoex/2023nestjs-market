...
const Profile: NextPage<Props> = ({}) => {
  return (
    <HeaderLayout hasTabBar title="나의 캐럿">
      <div className="px-4">
    ...
    //   <div className="flex">
    //     <div className="h-12 w-12 rounded-full bg-slate-400 mb-10" />
    //     <div className="flex flex-col items-center pl-2">
    //       <span className=" font-bold text-gray-900">steve Jebs</span>
    //       <span className="text-xs text-gray-700">Edit profile &rarr;</span>
    //     </div>
    //   </div>
    //   <div className="flex justify-around">
    //     <div className="flex flex-col items-center">
    //       <div className="w-14 h-14 flex items-center justify-center text-white bg-orange-600 rounded-full">
    //         <svg
    //           className="w-6 h-6"
    //           fill="none"
    //           stroke="currentColor"
    ...
    //       <div>
    //         <h4 className="text-sm font-bold text-gray-700">Ko</h4>
    //         <div className="flex items-center">
    //           <svg
    //             className="text-yellow-400 h-5 w-5"
    //             xmlns="http://www.w3.org/2000/svg"
