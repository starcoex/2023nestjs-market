      ...
      <div className="py-10 space-y-4 pb-16 px-4">
        ...
        <form action="" className="flexd py-2 bg-white bottom-0 inset-x-0">
          <div className="flex relative max-w-md items-center w-full mx-auto">
            <input
              type="text"
              className="shadow-sm w-full rounded-full border-gray-300 focus:ring-orange-500 focus:outline-none pr-12 
              focus:border-orange-500"
            />
            <div className="absolute right-0 py-1.5 pr-1.5 inset-y-0">
              <button className="flex focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 items-center bg-orange-500 rounded-full px-3 py-1 hover:bg-orange-600 text-sm text-white">
                &rarr;
              </button>
            </div>
          </div>
